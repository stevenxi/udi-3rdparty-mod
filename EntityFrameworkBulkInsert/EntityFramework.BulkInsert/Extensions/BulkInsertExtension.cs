    ...
    public static class BulkInsertExtension
    {
        ...
        */
        ...
        public static void BulkInsert<T>(this DbContext context, IEnumerable<T> entities, IDbTransaction transaction, BulkInsertOptions options)
        {
            var bulkInsert = ProviderFactory.Get(context);
            bulkInsert.Options = options;
            bulkInsert.Run(entities, transaction);
        }


        public static void BulkInsert<T>(this DbContext context, IEnumerable<T> entities, IDbConnection connection, BulkInsertOptions options)
        {
            var bulkInsert = ProviderFactory.Get(context);
            bulkInsert.Options = options;
            bulkInsert.Run(entities, connection, null);
        }
