...
namespace EntityFramework.Batch
{
    ...
    public interface IBatchRunner
    {
        ...
        int Delete<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, int? timeout)
            where TEntity : class;
        ...
        /// <param name="timeout">The query timeout.</param>
        /// <returns>The number of rows deleted.</returns>
        Task<int> DeleteAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, int? timeout)
            where TEntity : class;
        /// <summary>
        ...
        int Update<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression, int? timeout)
            where TEntity : class;
        ...
        /// <param name="timeout">The query timeout.</param>
        /// <returns>The number of rows updated.</returns>
        Task<int> UpdateAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression, int? timeout)
            where TEntity : class;
    }
}
