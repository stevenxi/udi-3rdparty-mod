...
namespace EntityFramework.Batch
{
    ...
    public class SqlServerBatchRunner : IBatchRunner
    {
        ...
        /// </returns>
        public int Delete<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, int? timeout) where TEntity : class
        {
            return InternalDelete(objectContext, entityMap, query, timeout, false).Result;
        }
        ...
        /// The number of rows deleted.
        /// </returns>
        public Task<int> DeleteAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, int? timeout) where TEntity : class
        {
            return InternalDelete(objectContext, entityMap, query, timeout, true);
        }

        private async Task<int> InternalDelete<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, int? timeout, bool async = false)
            where TEntity : class
        {
            ...
            try
            {
                ...
                deleteCommand = deleteConnection.CreateDbCommandWrapper();
                ...
                if (timeout.HasValue)
                    deleteCommand.CommandTimeout = timeout.Value;
        ...
        /// <param name="timeout">The update timeout.</param>
        /// <returns>
        /// The number of rows updated.
        /// </returns>
        public int Update<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression, int? timeout) where TEntity : class
        {
            return InternalUpdate(objectContext, entityMap, query, updateExpression, timeout, false).Result;
        }
        ...
        /// The number of rows updated.
        /// </returns>
        public Task<int> UpdateAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression, int? timeout) where TEntity : class
        {
            return InternalUpdate(objectContext, entityMap, query, updateExpression, timeout, true);
        }
        private async Task<int> InternalUpdate<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression, int? timeout, bool async = false)
            where TEntity : class
        {
            ...
            try
            {
                ...
                updateCommand = updateConnection.CreateDbCommandWrapper(); //updateConnection.CreateCommand();
                ...
                if (timeout.HasValue)
                    updateCommand.CommandTimeout = timeout.Value;
