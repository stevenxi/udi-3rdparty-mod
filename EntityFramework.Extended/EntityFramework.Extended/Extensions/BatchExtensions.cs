...
namespace EntityFramework.Extensions
{
    ...
    public static class BatchExtensions
    {
            ...
            where TEntity : class
        {
            ...
            return source.Where(filterExpression).Delete(timeout);
        }
        ...
        /// any entities that have already been materialized in the current context.        
        /// </remarks>
        public static int Delete<TEntity>(this IQueryable<TEntity> source, int? timeout = null)
            where TEntity : class
        {
            ...
            return runner.Delete(objectContext, entityMap, sourceQuery, timeout);
        }
            ...
            where TEntity : class
        {
            ...
            return source.Where(filterExpression).DeleteAsync(timeout);
        }
        ...
        /// any entities that have already been materialized in the current context.        
        /// </remarks>
        public static Task<int> DeleteAsync<TEntity>(this IQueryable<TEntity> source, int? timeout = null)
            where TEntity : class
        {
            ObjectQuery<TEntity> sourceQuery = source.ToObjectQuery();
            if (sourceQuery == null)
            ...
            var runner = ResolveRunner();
            return runner.DeleteAsync(objectContext, entityMap, sourceQuery, timeout);
        }
            ...
            where TEntity : class
        {
            ...
            var runner = ResolveRunner();
            return runner.Update(objectContext, entityMap, objectQuery, updateExpression, timeout);
        }
            ...
            where TEntity : class
        {
            ...
            return source.Where(filterExpression).Update(updateExpression, timeout);
        }
            ...
            where TEntity : class
        {
            ...
            var runner = ResolveRunner();
            return runner.Update(objectContext, entityMap, sourceQuery, updateExpression, timeout);
        }
            ...
            where TEntity : class
        {
            ...
            return source.Where(filterExpression).UpdateAsync(updateExpression, timeout);
        }
            ...
            where TEntity : class
        {
            ...
            var runner = ResolveRunner();
            return runner.UpdateAsync(objectContext, entityMap, sourceQuery, updateExpression, queryTimeout);
        }
